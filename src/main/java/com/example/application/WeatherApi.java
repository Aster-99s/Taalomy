...
public class WeatherApi implements Serializable
{
    ...
    private String name;
    private Integer cod;
    private final static long serialVersionUID = 8891564458672877033L;
     ...
     * @param wind
     */
    public WeatherApi(Coord coord, List<Weather> weather, String base, Main main, Integer visibility, Wind wind, Clouds clouds, Integer dt, Sys sys, Integer timezone, Integer id, String name, Integer cod) {
        super();
        this.coord = coord;
